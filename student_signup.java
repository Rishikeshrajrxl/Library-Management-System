...
public class student_signup implements ActionListener
{   
    ...
    student_signup()//constructor
    {
       ...
       f2.add(btnlogin);
       btnlogin.setBackground(new Color(100,200,10,10));
       ...
       btnlogin.addActionListener(new ActionListener()
       {
           ...
           {
               //login button
               student_login lp=new student_login ();
               f2.setVisible(false);
           }
       });
       f2.setVisible(true);
    ...
    {
        student_signup sign=new student_signup();
    }
    ...
    public void actionPerformed(ActionEvent ev)
    {
     ...
     else
     {
        ...
        PreparedStatement pcheck=conn.prepareStatement("select * from studentdetail where username='"+username+"' ");
