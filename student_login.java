...
class student_login implements ActionListener
{
    ...
    student_login()
    {
        ...
        JLabel l3=new JLabel("<html>Student<br>Login...</html>");
    ...
    else
    {
       ...
       try 
       {
           ...
           PreparedStatement ps=conn.prepareStatement("select * from studentdetail where username='"+s1+"' AND password='"+s2+"' ");
           ...
           if(rs.next())
           {
              ...
              studentpage sp=new studentpage(s1);
